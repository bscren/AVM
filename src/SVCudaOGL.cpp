...
bool CUDA_OGL::copyFrom(const cv::Mat& frame, const uint tex_id)
{
    ...
    cu_status = cudaMemcpy2D(dst, dpitch, frame.data, spitch, cu_width_, height_, cudaMemcpyHostToDevice);
