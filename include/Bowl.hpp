...
struct ConfigBowl
{
    ...
    //for different camera images to bev big image
    std::vector<glm::mat3> H; //camera to big
    std::vector<glm::mat3> invH; //big to camera
    glm::vec2     bevsize;
    glm::vec2     bewcentor;
    glm::vec4     bewcentorRC;
    float         viewdistscale = 3.0;//
