...
public:
    ...
    */
    ...
    float getCamSens() const {
        return sensitivity;
    }
    float getCamMVspeed() const {
        return mvspeed;
    }
    ...
    void setCamFront(const glm::vec3& cf) {
        camFront = cf;
    }
    void setCamUp(const glm::vec3& cu) {
        camUp = cu;
    }
    void setCamRight(const glm::vec3& cr) {
        camRight = cr;
    }
    void setWorldUp(const glm::vec3& wu) {
        worldUp = wu;
    }
    void setCamYaw(const float yaw) {
        this->yaw  = yaw;
    }
    void setCamPitch(const float pitch) {
        this->pitch = pitch;
    }
    void setCamSens(const float sens) {
        this->sensitivity = sens;
    }
    void setCamMVspeed(const float mvspeed) {
        this->mvspeed = mvspeed;
    }
    void setCamZoom(const float zoom) {
        this->zoom = zoom;
    }
